...
\section{FFS Images}
An FFS images consists of multiple binary structures, including the FFS header and the encrypted data. This section visualizes these binary structures for better understanding. Figure~\ref{fig:app_bin_ffs_header} visualizes binary format of the FFS header.
