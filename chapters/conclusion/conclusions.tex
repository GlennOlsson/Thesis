...
\Cref{sec:goals} presented seven subgoals of the thesis project. Goal 1-3 were successfully fulfilled when \gls{FFS} was implemented in chapter \Cref{ch:methods}. Goal 4 states that \gls{FFS} should provide deniability which is discussed in \Cref{sec:dis_sec} and is to some extent fulfilled by \gls{FFS}, although the filesystem is not completely deniable. Goal 5 and 6 are addressed in \Cref{sec:dis_fs,sec:imp}.
