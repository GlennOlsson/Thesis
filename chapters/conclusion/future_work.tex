...
% TODO: Add about \mbox{multi-user} support. You mount \gls{FFS} with your credentials, but the \gls{FFS} stack might have multiple users, you can only see your own files obviously

% TODO: Add about if \gls{FFS} becomes big, twitter will probably ban the accounts. Instead hide in better steganographic ways, such as small amounts of data in real images. More reliable towards detection for new accounts
