...
Along with increasing device storage cloud storage capacity is increasing. For instance Apple's iCloud service allows users to store up to 2TB of data in the cloud for a few U.S. Dollars per month % FIXME: CITE??
