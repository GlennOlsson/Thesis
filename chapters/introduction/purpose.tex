...
The purpose of this paper is to explore the possibility to store data on online services by creating a steganographic filesystem, and to compare the performance of such a filesystem to an actual distributed filesystem service. The interesting aspect of this is that services, such as social medias, provide users with essentially an infinite amount of storage. Anyone can create any number of accounts on Twitter and Facebook for free, and with enough accounts one could potentially store all their data using such a filesystem. The thesis explores the use of such a filesystem despite potentially being slower and less dependable than a filesystem that costs a few dollars per month. Further, is it ethically defendable to create and use such a system?
