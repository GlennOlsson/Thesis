...
\begin{enumerate}
	...
	\item Re-Read test for: File size = \SI{1024}{\kilo\byte}, buffer size = \SI{4}{\kilo\byte},
	\item Re-Write test for: File size = \SI{1024}{\kilo\byte}, buffer size = \SI{4}{\kilo\byte},
	...
	\item Read test for: File size = \SI{1024}{\kilo\byte}, buffer size = \SI{8}{\kilo\byte},
	\item Write test for: File size = \SI{1024}{\kilo\byte}, buffer size = \SI{8}{\kilo\byte}, et cetera
\end{enumerate}
...
\end{enumerate}
The biggest buffer size IOZone uses is \item \SI{16384}{\kilo\byte}, therefore the buffer sizes tested are:
\begin{enumerate}
	\item \SI{4}{\kilo\byte},
	\item \SI{8}{\kilo\byte},
