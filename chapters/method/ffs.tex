...
%TODO: write about limitations due to memory and storage. Must have enough memory to read all data in to memory, and enough storage to store the file (temporarely) before uploading to the OWS.
