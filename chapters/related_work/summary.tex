...
\begin{table}[!ht]
	\begin{center}
		\caption{Comparison between features present in related filesystems and \gls{FFS}. X means that the feature is supported and - means that it is not supported}
