...
\begin{figure}[!htb]
	...
	\begin{center}
		\includegraphics[width=1.0\textwidth]{figures/benchmarking/ffs/\gls{FFS}-box.pdf}
	\end{center}
...
\begin{figure}[!htb]
	...
	\begin{center}
		\includegraphics[width=1.0\textwidth]{figures/benchmarking/fake-ffs/Fejk \gls{FFS}-box.pdf}
	\end{center}
