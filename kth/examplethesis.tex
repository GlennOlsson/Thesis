...
\documentclass[english, bibtex]{kth/kththesis}
...
\input{kth/lib/includes}
\input{kth/lib/kthcolors}

%\glsdisablehyper
%\makeglossaries
%\makenoidxglossaries
%\include{kth/lib/acronyms}                %load the acronyms file

\input{kth/lib/defines}  % load some additional definitions to make writing more consistent
...
\input{kth/lib/includes-after-hyperref}

%\glsdisablehyper
\makeglossaries
\input{kth/lib/acronyms}                %load the acronyms file

% insert the configuration information with author(s), examiner, supervisor(s), ...
\input{kth/custom_configuration}
...
\input{kth/lib/pdf_related_includes}
...
Add the acronyms and abbreviations to kth/lib/acronyms.tex. Some examples are shown below:}
