...
\ifbiblatex
    ...
    \usepackage[natbib,maxcitenames=3,mincitenames=11,style=ieee,citestyle=numeric-comp,sorting=none,backend=biber,maxbibnames=99]{biblatex}
...
% \makeglossaries 
% \makenoidxglossaries
% \include{extras/acronyms}                %load the acronyms file
...
% \glsdisablehyper
\makeglossaries
\input{extras/acronyms}                %load the acronyms file
