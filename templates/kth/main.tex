...
\title{FFS: A secure cloud-based steganographic filesystem through exploitation of online web services}
\subtitle{Store your sensitive data in plain sight}

% give the alternative title - i.e., if the thesis is in English, then give a Swedish title
\alttitle{FFS: Ett säkert molnbaserat steganografiskt filsystem genom utnyttjande av onlinebaserade webtjänster}
